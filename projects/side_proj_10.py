...
def convert_excel_to_pdf(excel_path, output_pdf, page_size="A4", zoom='1.0', orientation='Landscape',
    ...
    for sheet_name in workbook.sheetnames:
        ...
        with NamedTemporaryFile(suffix='.html', delete=False) as html_file:
            ...
            # Set PDF options for landscape orientation, margins, and scaling
            pdf_options = {
                ...
                'margin-bottom': '10mm',
                'margin-left': '10mm',
                'zoom': str(zoom),  # Scaling down content to fit more rows per page
