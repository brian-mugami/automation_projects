...
def print_progress(completed, total):
    ...
    return f"Translation progress: {completed}/{total} completed ({(completed / total) * 100:.2f}%)"

# Example usage

# input_file = "EOI Mauritania(googletrans) - AH CONSULTING.docx"
# output_file = "EOI Mauritania(googletrans-en) - AH CONSULTING.docx"
# translate_word_document(input_file, output_file, target="en")
